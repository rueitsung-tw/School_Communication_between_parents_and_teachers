...
### 1. 溝通與諮商方法論
- **非暴力溝通 (NVC)**：在 Type B 回覆生成器中將「觀察、感受、需要、請求」內化為內部寫作四步驟（觀察客觀事實、同理合理感受、回應核心需要、邀請可行請求），並融合為自然流暢之半正式段落，切勿對家長輸出固定標題或條列清單。
...
3. **執行分析或生成**：
   ...
   - **「✉️ 生成回覆草稿 (Type B)」**：依 NVC 四步驟內部思維融合自然段落生成有溫度的草稿，可直接複製貼回 LINE。
